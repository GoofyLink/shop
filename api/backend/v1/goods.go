...
type GoodsCommon struct {
	PicUrl           string `json:"picUrl"           dc:"pic_url"            `       // 图片
...
type GoodsDeleteReq struct {
	g.Meta `path:"/v1/goods/delete" method:"delete" tags:"商品" summary:"删除商品分类接口"`
...
type GoodsUpdateReq struct {
	g.Meta `path:"/v1/goods/{Id}" method:"post" tags:"商品" summary:"修改商品分类接口"`
